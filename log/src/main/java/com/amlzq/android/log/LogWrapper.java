...
public class LogWrapper implements LogNode {
    ...
    private static String getLocation() {
        ...
        for (StackTraceElement targetStack : stackTraceElements) {
            ...
            if (targetStack.getClassName().equals(com.amlzq.android.log.LogWrapper.class.getName()))
                continue;

            if (targetStack.getClassName().equals(com.amlzq.android.log.Log.class.getName()))
                continue;
